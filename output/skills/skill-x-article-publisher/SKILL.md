---
id: "skill-x-article-publisher"
name: X Article Publisher
version: "1.0.0"
description: "Markdown→X Articles 发布 Skill：505 Stars，自动排版+发布"
category: prompt
tags: ["twitter", "x", "publish", "markdown", "social"]
author: "wshuyi"
repositoryUrl: "https://github.com/wshuyi/x-article-publisher-skill"
parameters:
    transport: "bundle"
    configTemplate: "{\"name\": \"X Article Publisher\", \"transport\": \"bundle\", \"type\": \"mcp\"}"
---
