...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glass': '0 8px 32px rgba(0,0,0,0.4), 0 0 0 0.5px rgba(255,255,255,0.05)',
        'glass-sm': '0 4px 16px rgba(0,0,0,0.3), 0 0 0 0.5px rgba(255,255,255,0.05)',
        'glass-lg': '0 16px 48px rgba(0,0,0,0.5), 0 0 0 0.5px rgba(255,255,255,0.08)',
        'glass-xl': '0 24px 64px rgba(0,0,0,0.6), 0 0 0 0.5px rgba(255,255,255,0.1)',
      },
      keyframes: {
        'slide-in-right': {
