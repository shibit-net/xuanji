...
import type { AppConfig, ILLMProvider, IToolRegistry } from '@/infrastructure/core-types';
import type { IPermissionController } from '@/permission/types';
import { join } from 'node:path';
import { homedir } from 'node:os';
import { existsSync, mkdirSync } from 'node:fs';
import { readFile, writeFile } from 'node:fs/promises';
import { DependencyContainer } from '@/engine/di';
...
import { getUserSessionsDir, getUserConfigPath, getUserMemoryPath, getUserMemoryDir } from '@/infrastructure/config/PathManager';
...
import { SessionStateMachine } from '@/agent/state/SessionStateMachine';
