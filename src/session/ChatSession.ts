...
import type { DependencyContainer } from '@/engine/di';
import type { IPermissionController, ConfirmationHandler, PlanReviewHandler } from '@/permission/types';
import type { IToolRegistry, AppConfig, AgentState } from '@/infrastructure/core-types';
import type { AskUserHandler } from '@/tools/AskUserTool';
