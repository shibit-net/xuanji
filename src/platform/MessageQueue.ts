...
export interface WorkerReplyHandler {
  sendReply(msg: PlatformMessage, text: string, imagePaths?: string[], audioPaths?: string[], videoPaths?: string[]): Promise<void>;
  ...
  async run(): Promise<void> {
    ...
    while (this.running) {
      ...
      try {
        ...
        await this.replyHandler.sendReply(payload, reply.text, reply.imagePaths, reply.audioPaths, reply.videoPaths);
