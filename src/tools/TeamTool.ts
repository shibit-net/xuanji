...
export class TeamTool extends BaseTool {
  ...
  readonly description = [
    ...
    '',
    '⛔ DELEGATION DISCIPLINE (same as task tool):',
    '',
    '1. After creating a team, YOU MUST NOT execute the same work yourself. The team IS doing it.',
    '2. Do NOT re-create a team for the same goal. If needed, use task_control to cancel first.',
    '3. The team frees your capacity for OTHER work. Focus elsewhere or wait for results.',
    '   Never say "the team is too slow, I\'ll do it myself" — they are already working.',
    '',
    'Example — parallel:',
    '  agent_team({',
